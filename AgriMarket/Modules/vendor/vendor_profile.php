...
$vendor = getVendorDetails($vendor_id, $conn); // Fetch vendor data
$subscription = getSubscriptionPlanName($vendor['subscription_id'], $conn); // Fetch subscription plan name
$user = getUserContact($vendor['user_id'], $conn); // Fetch user data (email, phone)
?>
...
<body class="vendor_profile" data-edit-success="<?php echo isset($_GET['update']) && $_GET['update'] == 'success' ? 'true' : 'false'; ?>">
        ...
        <?php if ($vendor): ?>
            <div class="profile-card">
                ...
                <div class="profile-details mt-3">
                    ...
                    <p><strong>Subscription Plan:</strong> <?= htmlspecialchars($subscription['plan_name'] ?? 'N/A'); ?></p>
                ...
                <button class="btn btn-primary edit-btn" data-bs-toggle="modal" data-bs-target="#editModal">Edit Store Profile</button>            </div>
        <?php else: ?>
