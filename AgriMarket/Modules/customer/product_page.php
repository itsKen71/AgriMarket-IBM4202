        ...
        <div class="product-box">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <!-- stock quantity -->
                    <p class="mt-3"><span style="color: #888888;">Stock:</span>
                        <?php echo $product['stock_quantity']; ?> Available</p> <!-- description -->
                    <div class="mt-4">
                        ...
                        <div class="shopping-protection-content">
                            <div class="card card-body bg-light mt-2 p-3">
                                <div class="mb-3">
                                    ...
                                    <p class="mb-0 small">
                                        Enjoy unconditional full refund within 15 days. Applies to eligible items.
                                        Electronic products must remain sealed (original packaging unbroken/unmodified).
                                        See terms for eligible products.
                                    </p>
                                </div>
                                <div class="mb-3">
                                    <h6 class="fw-bold"><img
                                            src="../../Assets/img/cash-on-delivery-cod-icon-260nw-2302469373 (1)-Photoroom.png"
                                            alt="COD Icon" style="height: 20px;"> Cash On Delivery (COD)</h6>
                                    <div class="small">
                                        <ol class="mb-0 ps-3">
                                            <li class="small">In Malaysia, Shopee offers COD for door-to-door deliveries
                                                or orders below RM250.</li>
                                            <li class="small">Your order will be delivered by Shopee Express, DHL
                                                eCommerce or Ninjavan. </li>
                                            <li class="small">Pay cash upon delivery.</li>
                                            <li class="small">Note: Payment amount will be rounded to the nearest 5 sen.
                                            </li>
                                            <li class="small">Important: Beware of fraud - never pay sellers directly
                                                for COD orders.</li>
                                        </ol>
                                    </div>
                                </div>
                    ...
                    <div class="mt-4 d-flex gap-3">
                        <?php if ($is_staff !== 'Staff'): ?>
                            ...
                            <button class="btn btn-danger px-4 py-2" style="width: 180px;" data-bs-toggle="modal"
            ...
            <div class="comment-box">
                <div class="border-bottom pb-3 mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-4">
                            <h2 class="text-warning mb-0"><?php echo number_format($avg_rating, 1); ?><small
                                    class="text-muted fs-6">/5</small></h2>
                        ...
                        <div class="flex-grow-1">
                            <div class="d-flex flex-wrap gap-2 mb-2">
                                <div class="rating-filter">
                                    <a href="?rating=0"
                                        class="btn btn-sm btn-outline-secondary <?= $selected_rating == 0 ? 'active' : '' ?>">All</a>
                                    <a href="?rating=5"
                                        class="btn btn-sm btn-outline-secondary <?= $selected_rating == 5 ? 'active' : '' ?>">5
                                        Stars (<?= $rating_counts[5] ?? 0 ?>)</a>
                                    <a href="?rating=4"
                                        class="btn btn-sm btn-outline-secondary <?= $selected_rating == 4 ? 'active' : '' ?>">4
                                        Stars (<?= $rating_counts[4] ?? 0 ?>)</a>
                                    <a href="?rating=3"
                                        class="btn btn-sm btn-outline-secondary <?= $selected_rating == 3 ? 'active' : '' ?>">3
                                        Stars (<?= $rating_counts[3] ?? 0 ?>)</a>
                                    <a href="?rating=2"
                                        class="btn btn-sm btn-outline-secondary <?= $selected_rating == 2 ? 'active' : '' ?>">2
                                        Stars (<?= $rating_counts[2] ?? 0 ?>)</a>
                                    <a href="?rating=1"
                                        class="btn btn-sm btn-outline-secondary <?= $selected_rating == 1 ? 'active' : '' ?>">1
                                        Star (<?= $rating_counts[1] ?? 0 ?>)</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php if (count($reviews) > 0): ?>
                    <?php foreach ($reviews as $row): ?>
                        <div class="border-bottom pb-4 mb-4 d-flex">
                            ...
                            <div class="flex-grow-1">
                                <!-- username -->
                                <div class="fw-bold"><?= htmlspecialchars($row['first_name'] . ' ' . $row['last_name']); ?>
                                </div>
                                <!-- rating -->
                                <div class="text-warning">
                ...
                <div class="modal-content">
                    <form method="post" action="" id="cartForm">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="quantityInput" class="form-label">Quantity (Available: <span
                                        id="availableStock"><?php echo $product['stock_quantity']; ?></span>)</label>
                ...
                <div class="modal-content">
                    <form method="post" action="check_out.php" id="buyNowForm">
                        ...
                        <div class="modal-body">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="buyNowQuantity" class="form-label">Quantity (Available: <span
                                            id="availableStock"><?php echo $product['stock_quantity']; ?></span>)</label>
                                    <input type="number" class="form-control" id="buyNowQuantity" name="quantity"
